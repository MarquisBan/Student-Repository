import unittest
import sqlite3
from HW11_Chengyi_Zhang import file_reader, read_sts, read_maj, read_ins
...
class MyTestCase(unittest.TestCase):
    ...
    def test_query(self):
        # Test Students.student_grades_table_db
        db = sqlite3.connect("810_Database.db")
        # Well, I cannot come up with a method to test this.
        db.close()
